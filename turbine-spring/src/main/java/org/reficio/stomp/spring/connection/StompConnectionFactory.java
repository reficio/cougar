...
public class StompConnectionFactory<T extends StompResource> implements ConnectionFactory<T> {
    ...
    protected boolean autoTransactional = false;
    protected boolean transactionalReception = false;
	...
	public T createConnection() {
        try {
            ...
            // connection.decorate(autoAcknowledge, transactional, transactionalReception);
            connection.init();
            return connection;
